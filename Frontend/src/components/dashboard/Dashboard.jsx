...
import "../../assets/styles/Dashboard.css"; // Assuming you have a CSS file for styling
...
const Dashboard = () => {
  ...
  const stats = {
    ...
    activeAgents: agentsArray.filter((agent) => agent.status === "active")
      .length,
    totalTools: toolsArray.length,
    totalLogs: logsArray.length,
    querySuccess: logsArray.filter(
      (log) => log.type === "query" && log.status === "success"
    ).length,
    queryTotal: logsArray.filter((log) => log.type === "query").length,
  };
      ...
      <div className="welcome-card">
        <div className="welcome-content">
          ...
          <p>
            ...
            Use natural language to interact with your agents and integrate with
            external services.
          </p>
        </div>
                    ...
                    <li key={agent._id} className="entity-item">
                      <Link to={`/agents/${agent._id}`}>
                        <div className="entity-icon">
                          <i
                            className={`fas fa-robot ${
                              agent.type?.toLowerCase() || "default"
                            }`}
                          ></i>
                        </div>
                        <div className="entity-info">
                          ...
                          <p>
                            {(agent.description || "No description").substring(
                              0,
                              60
                            )}
                            ...
                    ...
                    <li key={tool._id} className="entity-item">
                      <Link to={`/tools/${tool._id}`}>
                        ...
                        <div className="entity-info">
                          ...
                          <p>
                            {(tool.description || "No description").substring(
                              0,
                              60
                            )}
                            ...
